...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        action='store_true',
        help=
        'whether applying jpeg and gaussian noising augmentation in training a sr model'
    )
    ...
    parser.add_argument('--spa_loss', type=str, default='l2')
    parser.add_argument('--fre_loss', type=str, default='fft')
    ...
    for epoch in range(args.num_epochs):
        ...
        with tqdm(total=(len(train_dataset) -
            ...
            for data in train_dataloader:
                ...
                loss = criterion(
                    preds,
                    labels) + criterion_vgg(preds, labels) * args.vgg_lambda
